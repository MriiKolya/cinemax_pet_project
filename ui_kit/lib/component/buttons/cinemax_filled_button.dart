...
class CinemaxFilledButton extends StatefulWidget {
...
class _CinemaxFilledButtonState extends State<CinemaxFilledButton>
  ...
  Widget build(BuildContext context) {
    final style = context.filledButtonStyle;
